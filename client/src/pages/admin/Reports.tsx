            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="text-left px-3 py-3 font-medium text-gray-600 hidden sm:table-cell">门店</th>
              ...
              <tbody className="divide-y divide-gray-100">
                {rows.map((row) => (
                  <tr key={row.userId}>
                    ...
                    <td className="px-3 py-3 text-gray-500 hidden sm:table-cell">{row.storeName}</td>
                    ...
                    <td className="px-3 py-3 text-center">
                      {row.lateCount > 0 ? (
                        <span className="text-red-600 font-medium">{row.lateCount}</span>
                      ) : (
                    ...
                    <td className="px-3 py-3 text-center">
                      {row.earlyCount > 0 ? (
                        <span className="text-orange-600 font-medium">{row.earlyCount}</span>
                      ) : (
                        <span className="text-gray-300">0</span>
                      )}
                    </td>
                    <td className="px-3 py-3 text-center">
                      {row.missingClockOut ? (
                        <span className="text-xs bg-red-100 text-red-600 px-2 py-0.5 rounded-full">缺下班卡</span>
                      ) : (
              ...
              <tfoot>
                <tr className="bg-gray-100 font-semibold border-t-2 border-gray-300">
                  ...
                  <td className="px-3 py-3 text-gray-500 hidden sm:table-cell"></td>
                  ...
                  <td className="px-3 py-3 text-center">
                    {summary.missingClockOut ? (
                      <span className="text-xs bg-red-100 text-red-600 px-2 py-0.5 rounded-full">有异常</span>
                    ) : (
                      <span className="text-xs bg-green-100 text-green-600 px-2 py-0.5 rounded-full">正常</span>
                    )}
                  </td>
